 ...
 class OrderClass
 {
        ...
        private static function send_order_activation_email($order_id, $post_array) 
        {
                ...
                $message .= "Wanneer u op de onderstaande link klikt, gaat u<br>
                			 ...
                			 definitief.<br><br>";
                $message .= "<a href='http://localhost/Projecten%20blok%202/fotosjaak/index.php?content=confrim_order&email=test&password=geheim'>opdracht is akkoord</a>";
